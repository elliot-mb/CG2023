...
int main(int argc, char *argv[]) {
    ...
    ModelLoader* tallBox = new ModelLoader("tall_box.obj", 0.25, glm::vec3(0.45, -1.0, 1), 0.64, ModelLoader::mtl);
    ModelLoader* mirrorBox = new ModelLoader("tall_box.obj", 0.25, glm::vec3(-0.6, -1.0, 1), 0.8, ModelLoader::mrr);
