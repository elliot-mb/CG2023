...
glm::mat3 Utils::pitch(float angle){
    if(angle < 0) angle += 1.570596 * 4;
    float cTx = glm::cos(angle + (1.570596 * 4));
    float sTx = glm::sin(angle + (1.570596 * 4));
...
glm::mat3 Utils::yaw(float angle){
    if(angle < 0) angle += 1.570596 * 4;
    float cTy = glm::cos(angle + (1.570596 * 4));
    float sTy = glm::sin(angle + (1.570596 * 4));
